        ...
        >
          ...
          <div className="text-center mb-16">
            ...
            <p className="max-w-3xl mx-auto text-gray-400 text-lg leading-relaxed">
              Photography was my first professional creative discipline. Today it remains a way to observe people, light, emotion and stories beyond engineering and code.
            </p>
